...
@section('title', 'Создание цвета продукта')
	...
	<div class="container-fluid">
		...
		<div class="dashboard-section">
			...
			<div class="section-heading clearfix">
				<h2 class="section-title">Создание цвета</h2>
			</div>
			...
			<div class="panel-content">
              ...
              @error('slug')
						...
						<div class="form-group">
							...
							<input type="color" id="hex_code" class="form-control @error('hex_code') parsley-error @enderror" name="hex_code" value="{{ old('hex_code', '') }}">
